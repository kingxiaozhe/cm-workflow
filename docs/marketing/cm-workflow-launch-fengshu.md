<!--
标题候选：
1. 我不是想让 AI 多写代码，我只想知道它到底有没有落地
2. 被 AI 的「已经完成」坑过以后，我做了一套开发工作流
3. AI 编程最缺的，可能不是更强的模型，而是一只黑匣子

发布前核对：
- 文中两次踩坑来自原发布稿，请作者再次确认细节可公开。
- 发布前确认仓库地址、安装命令与当前公开版本一致。
- 公众号自带署名，正文不另落款。
-->

# 我不是想让 AI 多写代码，我只想知道它到底有没有落地

![CM Workflow：飞机是否真正落地，要看轮子有没有接地](assets/cm-workflow-fengshu/01-cover-touchdown.png)
...
![强大的发动机之外，还需要经过批准的航线和逐项执行的检查单](assets/cm-workflow-fengshu/02-engine-flightplan-checklist.png)
...
![代码逻辑、执行命令和浏览器路径三类证据，最终汇入可追溯的黑匣子](assets/cm-workflow-fengshu/03-evidence-blackbox-touchdown.png)
...
仓库地址：<https://github.com/kingxiaozhe/cm-workflow>
